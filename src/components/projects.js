                ...
                <div className="project-item">
                    ...
                    <div className="project-item-content">
                        ...
                        <ul>
                            ...
                            <li className="project-item-list">Diaphragm flexure in parallel configuration to maximise bearing stiffnesses, hence minimizing unwanted off-axis motions</li>
                            <li className="project-item-list">Integrated capacitive sensor for active feedback control.</li>
                            <li className="project-item-list">Capacitance to voltage sensing driver circuitry in development.</li>
                ...
                <div className="project-item">
                    ...
                    <div className="project-item-content">
                        ...
                        <ul>
                            ...
                            linear gantry with a NEMA-17 stepper motor to water multiple plants selectively with a single pump </li>
                            <li className="project-item-list">Regulates soil moisture with sensor readings from 10+ multiplexed capacitive sensors. </li>
