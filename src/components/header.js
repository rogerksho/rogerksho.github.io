...
import "../styles.css";
import face from "../img/face_japan.jpg"
    ...
    return (
        <div className="header">
          ...
          <div className="intro-div">
            ...
            as a mechatronics engineer. During my time at the university, I worked on the design and testing of a flexure-based high performance (large range, high speed, nanometric motion quality)
